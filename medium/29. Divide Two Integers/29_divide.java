//To divide two integers without using multiplication, division, and mod operator, 
//I employed bit manipulation and simulated the division process. 
//Firstly, I handled overflow cases where the dividend is Integer.MIN_VALUE and 
//the divisor is -1 or 1. Then, I converted both numbers to negatives and counted the 
//number of negative signs. After that, I found the largest doubling of the divisor that 
//could fit into the dividend in the negative 32-bit integer range. 
//Starting from the biggest bit, I shifted the divisor to the right until I couldn't shift 
//it further, updating the quotient accordingly. 
//Finally, I adjusted the sign of the quotient based on the count of negative signs.
