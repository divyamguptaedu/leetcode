//To solve the problem of evaluating division queries given variable pairs and 
//their ratios, I used a union-find (disjoint-set) data structure. 
//I represented each variable and its relationship using a hashmap where each key 
//is a variable and the value is a pair consisting of a parent variable and 
//the weight (representing the division result with the parent). 
//I performed union operations to connect variables and find operations to 
//evaluate the queries by checking if variables are connected and 
//then computing the division result based on stored weights.

//Time: (M+N)logN where n is the number of input equations and M is the num queries.
//Space: N
class Solution {
